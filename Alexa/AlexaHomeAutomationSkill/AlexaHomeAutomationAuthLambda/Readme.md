...
```
    cd "AlexaHomeAutomationAuthLambda"
    dotnet restore
```

Execute unit tests
```
    cd "AlexaHomeAutomationAuthLambda/test/AlexaHomeAutomationAuthLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AlexaHomeAutomationAuthLambda/src/AlexaHomeAutomationAuthLambda"
