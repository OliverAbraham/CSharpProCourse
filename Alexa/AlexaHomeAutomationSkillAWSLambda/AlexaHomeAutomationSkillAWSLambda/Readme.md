...
```
    cd "AlexaHomeAutomationSkillAWSLambda"
    dotnet restore
```

Execute unit tests
```
    cd "AlexaHomeAutomationSkillAWSLambda/test/AlexaHomeAutomationSkillAWSLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AlexaHomeAutomationSkillAWSLambda/src/AlexaHomeAutomationSkillAWSLambda"
