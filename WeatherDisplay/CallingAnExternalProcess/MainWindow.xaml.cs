using Abraham.ExternalProcesses;
using Abraham.String;
using System;
using System.Windows;
using System.Windows.Threading;

namespace CallingAnExternalProcess
{
	/// <summary>
	/// ATTENTION: This is a bad solution! It's just for demonstration what can be done!
	/// </summary>
	public partial class MainWindow : Window
	{
		...
		{
			var starter = new ExternalProcessStarter();
			var page = starter.CallProcessAndReturnConsoleOutput("cmd" , "/K curl " + _url + " & exit");
			return page;
		}
